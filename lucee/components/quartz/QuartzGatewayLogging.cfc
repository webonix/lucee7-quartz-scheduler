...
var message = "#dateTimeFormat(Now(), 'dd-Mmm-YYYY HH:nn:ss.lll')# QS GATEWAY :: #arguments.id# init()"; 
...
var message = "#dateTimeFormat(Now(), 'dd-Mmm-YYYY HH:nn:ss.lll')# QS GATEWAY :: start()"; 
systemOutput(local.message, true, false);
